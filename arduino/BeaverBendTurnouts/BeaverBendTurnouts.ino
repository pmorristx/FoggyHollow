...
const uint8_t LEFT_THROWN_PANEL_PIN 	= 9;
const uint8_t LEFT_CLOSED_PANEL_PIN 	= 10;
const uint8_t RIGHT_THROWN_PANEL_PIN 	= 11;
const uint8_t RIGHT_CLOSED_PANEL_PIN 	= 12;
...
const uint8_t LEFT_THROWN_PANEL_IDX 	= 9;
const uint8_t LEFT_CLOSED_PANEL_IDX 	= 10;
const uint8_t RIGHT_THROWN_PANEL_IDX 	= 11;
const uint8_t RIGHT_CLOSED_PANEL_IDX 	= 12;
