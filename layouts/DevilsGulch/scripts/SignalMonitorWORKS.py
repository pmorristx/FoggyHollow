...
class SignalMonitor(jmri.jmrit.automat.AbstractAutomaton) :
    ...
    def init(self):
        ...
        for i in range(len(SignalList)) :
            ...
            DeviceList[SignalName].init(SignalName, memories.provideMemory(SignalName), signalStates, logFile)
    ...
    class TrackDevice(java.beans.PropertyChangeListener) :
        ...
        #
        def init(self, aName, aDevice, aAllowedStates, aLogFile) :
            ...
            self.delayTimer = javax.swing.Timer(1000, self.timeoutListener)
...
###            self.Device.setState(self.DeviceValue)
            ...
            if (self.DeviceValue == "P") :
                ...
                sensors.getSensor( signalId + ":TOP").setState(INACTIVE)
            print "Done with setInitDeviceState \n"
            return
